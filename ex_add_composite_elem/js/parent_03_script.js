function input_03_1_clicked(event,theParent) {
  console.log('enter function input_03_1_clicked');
  let modkey = event.getModifierState("Alt"); // Alt is Option on Mac
  if (modkey == false) {
    console.log('  in input_03_1_clicked, modkey is false');
    let el = document.getElementById(theParent);
    console.log('  in input_03_1_clicked, after querySelector, el = ' + el);
    let x = el.offsetLeft;
    let y = el.offsetTop;
    let dx = 5;
    let dy = 5;
